...
public class JsonController {
	...
	public ResponseEntity<Object> JsonUppercaseToJson(@RequestBody JsonUpperCaseToCamelRequestModel request)
		...
		List<String> listPropertiesUppercase = JsonHelper.ListPropertiesFromJsonStringNoEscape(request.getUppercaseJsonString());
	...
	public ResponseEntity<Object> testGetKeyIsVariableMap(@RequestParam(name = "key") String key)
			throws Exception {
		String value="";
